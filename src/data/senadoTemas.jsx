        ...
        texto: (
          <>
            <p>
              ...
              Villarruel agradeció al Presidente Javier Milei por acompañarla
              en esta labor y expresó:{" "}
            </p>
            <blockquote className="cita">
              "Han sido 42 años de desmalvinización y olvido. Es momento de
              recuperar el respeto por nuestras Fuerzas Armadas y por los
              Héroes de Malvinas."
            </blockquote>
            <p>
        ...
        texto: (
          <>
            <p>
              ...
              junto al gobernador Gustavo Melella, el intendente Walter Vuoto
              y el presidente del Centro de Excombatientes, Juan Carlos
              Parodi.
              <br />
              <br />
            ...
            <blockquote className="cita">
              ...
              Fuerzas Armadas que lucharon en Malvinas es el pilar desde el
              que comenzaremos la reconstrucción de nuestro país", expresó.
            </blockquote>
            <p>
        ...
        texto: (
          <>
            ...
            <blockquote className="cita">
              ...
              multiplicaron. Hoy la Nación los abraza y los reconoce como lo
            ...
            <p>
              ...
              <span className="vv-estilo-detalle">
                El acto concluyó con los homenajeados y Villarruel entonando
        ...
        texto: (
          <>
            <p>
              ...
              vicepresidente de la Nación, Victoria Villarruel, participó en
              la ciudad de Chivilcoy de un acto homenaje a los Veteranos y
              Caídos en la Guerra de Malvinas, realizado en la Plaza 25 de
              Mayo junto al intendente Guillermo Britos.{" "}
              <span className="vv-estilo-detalle">
              ...
              decidió no participar de la tradicional vigilia en Tierra del
              Fuego porque no quería prestarse a una utilización política de
              la causa. En ese marco, expresó:
            </p>

            <blockquote className="cita">
              "Malvinas no es una excusa para que se diriman internas de un
              partido político. Es homenaje y gratitud para los argentinos
              que defendieron nuestra tierra frente al invasor inglés."
            </blockquote>
            ...
            <p>
              ...
              <span className="vv-estilo-detalle">
                ...
                representa "la única causa nacional que une a los argentinos
                sin diferencias de ideología, religión u origen social".
              </span>{" "}
              <br />
              <br />
            ...
            <p>
              ...
              Armadas tras el conflicto y remarcó la necesidad de recuperar
              el reconocimiento y respeto hacia quienes combatieron por la
              Patria.{" "}
              <span className="vv-estilo-detalle">
                El acto reunió a veteranos, vecinos y autoridades locales en
                una jornada de homenaje y memoria por los héroes de Malvinas.
              </span>
            </p>
          </>
        ),
    ...
    actividades: [
      {
        ...
        texto: (
          <>
            <p>
              <span className="tema-fecha">- AGOSTO 2024 -</span>El Senado de
              la Nación rindió{" "}
              <span className="vv-estilo-detalle">
              ...
              <span className="vv-estilo-detalle">
                Villarruel, destacó el compromiso con la memoria, la justicia
            ...
            <blockquote className="cita">
              ...
              inspira más que en el profundo amor a la Argentina. Reabriremos
              todas las causas de víctimas del terrorismo para que la
              Justicia haga lo que debió hacer hace más de 20 años."
            </blockquote>
            <p>
        ...
        texto: (
          <>
            ...
            <blockquote className="cita">
              ...
              políticas, religiosas o sociales. Ninguna idea puede ser
              defendida a través de ataques que agreden a personas
              inocentes."
            </blockquote>
            <p>
              Además,{" "}
              <span className="vv-estilo-detalle">
                destacó la necesidad de dar apoyo a las víctimas y familiares
                y reafirmó el compromiso de justicia, memoria y reparación.
              </span>{" "}
